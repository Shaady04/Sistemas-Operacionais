 ...
 *RR: Round Robin (com quantum = 2) 
    (Otimizar o código posteriormente)
 */
...
/*Essa função teoricamente era pra executar, mas apenas imprime*/
int Executa_FCFS(list<FCFS> &fifo){
...
/*Nessa função eu reorganizo a lista SJF pelo critério do tempo de pico
  uma vez que todos os processos já chegaram na fila, basta organizá-los pela prioridade estabelecida */
bool SJF_Puro(SJF first, SJF second){ 
...
/*Esta função apenas auxilia a organizar a lista pelo parãmetro de chegada
  só utilizo esta função no começo de cada lista para garantir a ordenação  */
bool Compara_SJF(SJF first, SJF second){
